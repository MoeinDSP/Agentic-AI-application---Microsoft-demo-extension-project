...
class PlacesApiSettings(BaseSettings):
    """Google Places API settings for direct restaurant search."""
...
class EnvironmentService(metaclass=SingletonMeta):
    ...
    def google_places_api_key(self) -> str:
        """Return the Google Places API key for direct Nearby Search calls."""
        return self._env.places_api.google_places_api_key
